...
public class Room 
{
	...
	private Character eliteMercenary;
	...
	public void checkAlert(Player player)
	{
		...
		{
			if(eliteMercenary != null && !characterInRoom.contains(eliteMercenary))
			{
				System.out.println(((NPC)eliteMercenary).getAlt());
				characterInRoom.add(eliteMercenary);
				System.out.println("Alert triggered!" + eliteMercenary.getName() 
				+ "has appeared!\n");
			}
		}
	}

	public void setEliteMercenary(Character eliteMerc)
	{
